...
1. **直接下载模式**：应用会在服务器上下载和转换YouTube视频，然后直接将MP3文件提供给用户下载，无需跳转到第三方网站。

2. **第三方网站模式**：应用会提供多个知名的在线转换服务选项，当用户点击下载按钮时，系统会自动打开一个可靠的第三方转换网站（如Y2mate, onlinevideoconverter等），用户可以在那里完成下载。

用户可以根据自己的需求选择使用哪种下载方式。直接下载模式更加便捷，第三方网站模式可作为备选，提高下载成功率。
